...
export default function ProductList() {
  ...
  const [newAccessoryForAdd, setNewAccessoryForAdd] = useState({
    name: "",
    price: "",
    description: "",
  }); // State for accessory in add modal
  ...
  const confirmDelete = () => {
    ...
    axios
      .delete(`http://localhost:5001/api/auth/products/${id}`)
      .then(() => {
  ...
  const submitEdit = (e) => {
    ...
    axios
      .put(
        `http://localhost:5001/api/auth/products/${productToUpdate.id}`,
        productToUpdate
      )
      .then((response) => {
  ...
  const submitAddProduct = (e) => {
    ...
    axios
      .post("http://localhost:5001/api/auth/products", newProduct)
      .then((response) => {
        ...
        >
          ...
          {selectedProduct ? (
            <div>
              ...
              <p>
                <strong>Warranty:</strong> ${selectedProduct.warranty_price}
              </p>
              <p>
                <strong>Retailer-Special-Discounts:</strong> $
                {selectedProduct.retailer_special_discounts}
              </p>
              <p>
                <strong>Manufacturer-Rebate:</strong> $
                {selectedProduct.manufacturer_rebates}
              </p>
              <p>
              ...
              {selectedProduct.accessories.map((accessory, index) => (
                <div key={index}>
                  ...
                  <p>
                    <strong>Accessory Name:</strong> {accessory.name}
                  </p>
                  <p>
        ...
        >
          ...
          <form onSubmit={submitAddProduct}>
            ...
            <input
              type="text"
              name="warranty_price"
              value={newProduct.warranty_price}
              onChange={handleNewProductInputChange}
            />
            <label>Retailer-Special-Discounts</label>
            <input
              type="text"
              name="retailer_special_discounts"
              value={newProduct.retailer_special_discounts}
              onChange={handleNewProductInputChange}
            />
            <label>Manufacturer-Rebate</label>
            <input
              type="text"
              name="manufacturer_rebates"
              value={newProduct.manufacturer_rebates}
              onChange={handleNewProductInputChange}
            />
            ...
            <input
              ...
              name="id"
              value={newAccessoryForAdd.id}
              onChange={handleNewAccessoryForAddChange}
            />
            <input
              type="text"
              placeholder="Accessory Name"
              name="name"
              value={newAccessoryForAdd.name}
              onChange={handleNewAccessoryForAddChange}
            />
            <input
              type="text"
              ...
              name="price"
              value={newAccessoryForAdd.price}
              onChange={handleNewAccessoryForAddChange}
            />
            <input
              type="text"
              ...
              name="description"
              value={newAccessoryForAdd.description}
              onChange={handleNewAccessoryForAddChange}
            />
            <button
              style={{ backgroundColor: "#218838" }}
              type="button"
              onClick={addAccessoryForAdd}
            >
              Add Accessory
            </button>
        ...
        >
          ...
          <form onSubmit={submitEdit}>
            ...
            <input
              type="text"
              name="warranty_price"
              value={editedProduct.warranty_price}
              onChange={handleInputChange}
            />
            <label>Retailer-Special-Discounts</label>
            <input
              type="text"
              name="retailer_special_discounts"
              value={editedProduct.retailer_special_discounts}
              onChange={handleInputChange}
            />
            <label>Manufacturer-Rebate</label>
            <input
              type="text"
              name="manufacturer_rebates"
              value={editedProduct.manufacturer_rebates}
              onChange={handleInputChange}
            />
            <label>AvailableItems</label>
            <input
              type="text"
              name="availableItems"
              value={editedProduct.availableItems}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              onChange={(e) =>
                setNewAccessory({ ...newAccessory, id: e.target.value })
              }
            />
            <input
              type="text"
            ...
            <div className="button-container">
              <button style={{ backgroundColor: "#218838" }} type="submit">
                Save Changes
              </button>
              <button
                type="button"
