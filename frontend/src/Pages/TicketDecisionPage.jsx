...
const TicketDecisionPage = () => {
    ...
    const handleFetchDecision = async (event) => {
        ...
        try {
            // Correctly append ticketNumber to the API endpoint
            const response = await fetch(`http://localhost:5001/api/auth/tickets/${ticketNumber}`, {
                method: 'GET',
            });
            ...
            console.error('Error fetching ticket decision:', error);
