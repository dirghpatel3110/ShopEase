...
const OpenTicketPage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append('ticketImage', image); // Ensure the field name matches backend
        ...
        try {
            ...
            // Notify user about ticket number
            if (data.ticketNumber) {
                alert(`Ticket Number: ${data.ticketNumber}. Keep it for future reference.`);
            }
        } catch (error) {
